...
namespace ONIGIRIX_GUI {
	...
	typedef void(*call_funk_scroll)(Rectangle*,int);

	class Scroll {
	public:
		Scroll(Fenetre* f, Mesure h1, Mesure h2, Mesure w, Mesure x, Mesure y, bool);

		void set_relative(Relative* RelativeElement);
		...
		void add_on_change(call_funk_scroll);
		void remove_on_change();

		call_funk_scroll onchange;

		call_funk_scroll callback = NULL;
