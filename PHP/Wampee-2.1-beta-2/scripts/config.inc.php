...
$wampeeConfFile		   = '../resources/wampee.ini';
$wpcf			 	   = @parse_ini_file($wampeeConfFile);
$c_wpfport			   = $wpcf['apache'];
...
$c_phpTplConfFile 		= $c_apacheTplVersionDir.'/apache'.$wampConf['apacheVersion'].'/'.$wampConf['apacheExeDir'].'/'.$wampConf['phpConfFile'];
